            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li @click="menu=1"><a href="">Metodos de pago</a></li>
                        <li @click="menu=2"><a href="">link</a></li>
                        <li @click="menu=3"><a href="">link</a></li>
                        <li @click="menu=4"><a href="">link</a></li>
                        <li @click="menu=5"><a href="">link</a></li>
                        <li @click="menu=6"><a href="">link</a></li>
                        <li @click="menu=7"><a href="">link</a></li>
                        <li @click="menu=8"><a href="">link</a></li>
                        <li @click="menu=9"><a href=""></a></li>
                        <li @click="menu=10"><a href=""></a></li>
                        <li @click="menu=11"><a href=""></a></li>
                        <li @click="menu=12"><a href=""></a>
                        <li @click="menu=13"><a href=""></a>
                        <li @click="menu=14"><a href=""></a>
                        <li @click="menu=15"><a href=""></a></li>
                    </ul>
                </li>
...
</div><?php /**PATH /opt/lampp/htdocs/Proyecto/freelancer/resources/views/base/sidebarAdmin.blade.php ENDPATH**/ ?>